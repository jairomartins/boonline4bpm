    ...
    <>
      ...
      <Container>
        ...
        <FormBuscarUsuario
          ...
          handleClickBuscarUsuarios={handleClickBuscarUsuario}
        />
        <Row>
        ...
        {exibirTabelaUsuarios ? (
          <TabelaUsuarios
            ...
            handleClickEditarUsuario={handleClickEditarUsuario}
            handleClickRemoverUsuario={handleClickRemoverUsuario}
            setIdBusca={idBusca}
          />
        ) : (
          ""
        ...
        {exibirFormEdicao ? (
          <EditarUsuario
            ...
            setExibirFormEdicao={setExibirFormEdicao}
          />
        ) : (
          ""
        )}
